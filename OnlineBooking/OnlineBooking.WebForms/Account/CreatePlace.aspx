                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <%--<asp:RequiredFieldValidator  ID="RequiredFieldValidatorPlaceName" ControlToValidate="PlaceName" runat="server" Display="Dynamic" Text="Required Field" ErrorMessage="Plaec Name is required!" ForeColor="Red" EnableClientScript="False" />--%>
                        </div>
                    </div>
